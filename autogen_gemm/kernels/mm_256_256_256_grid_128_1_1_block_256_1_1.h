...
extern "C" __global__ void __launch_bounds__(256)
    mm_256_256_256(float* __restrict__ A, float* __restrict__ B,
  ...
  for (int k_outer = 0; k_outer < 8; ++k_outer) {
    __syncthreads();
    A_shared[(((int)threadIdx.x))] = A[((((((((int)blockIdx.x) >> 4) * 8192) +
                                           ((((int)threadIdx.x) >> 5) * 256)) +
                                          (k_outer * 32)) +
                                         (((int)threadIdx.x) & 31)))];
    A_shared[((((int)threadIdx.x) + 256))] =
        A[(((((((((int)blockIdx.x) >> 4) * 8192) +
               ((((int)threadIdx.x) >> 5) * 256)) +
              (k_outer * 32)) +
             (((int)threadIdx.x) & 31)) +
            2048))];
    ...
    B_shared[(((int)threadIdx.x))] =
        B[(((((k_outer * 8192) + ((((int)threadIdx.x) >> 4) * 256)) +
             ((((int)blockIdx.x) & 15) * 16)) +
            (((int)threadIdx.x) & 15)))];
  ...
  compute[((
      ((((((int)blockIdx.x) >> 4) * 8192) + ((((int)threadIdx.x) >> 4) * 256)) +
       ((((int)blockIdx.x) & 15) * 16)) +
      (((int)threadIdx.x) & 15)))] = compute_local[(0)];
  compute[(((((((((int)blockIdx.x) >> 4) * 8192) +
