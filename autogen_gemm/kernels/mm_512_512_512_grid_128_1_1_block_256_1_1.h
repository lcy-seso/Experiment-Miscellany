...
extern "C" __global__ void __launch_bounds__(256)
    mm_512_512_512(float* __restrict__ A, float* __restrict__ B,
  ...
  for (int k_outer = 0; k_outer < 16; ++k_outer) {
    __syncthreads();
    A_shared[(((int)threadIdx.x))] = A[((((((((int)blockIdx.x) >> 4) * 32768) +
                                           ((((int)threadIdx.x) >> 5) * 512)) +
                                          (k_outer * 32)) +
                                         (((int)threadIdx.x) & 31)))];
    A_shared[((((int)threadIdx.x) + 256))] =
        A[(((((((((int)blockIdx.x) >> 4) * 32768) +
               ((((int)threadIdx.x) >> 5) * 512)) +
              (k_outer * 32)) +
             (((int)threadIdx.x) & 31)) +
            4096))];
  ...
  compute[((((((((int)blockIdx.x) >> 4) * 32768) +
  ...
  compute[(((((((((int)blockIdx.x) >> 4) * 32768) +
              ...
              ((((int)blockIdx.x) & 15) * 32)) +
             (((int)threadIdx.x) & 15)) +
            16384))] = compute_local[(4)];
  compute[(((((((((int)blockIdx.x) >> 4) * 32768) +
               ((((int)threadIdx.x) >> 4) * 512)) +
              ((((int)blockIdx.x) & 15) * 32)) +
             (((int)threadIdx.x) & 15)) +
            24576))] = compute_local[(6)];
  compute[(((((((((int)blockIdx.x) >> 4) * 32768) +
               ((((int)threadIdx.x) >> 4) * 512)) +
              ((((int)blockIdx.x) & 15) * 32)) +
             (((int)threadIdx.x) & 15)) +
  ...
  compute[(((((((((int)blockIdx.x) >> 4) * 32768) +
              ...
              ((((int)blockIdx.x) & 15) * 32)) +
             (((int)threadIdx.x) & 15)) +
            16400))] = compute_local[(5)];
  compute[(((((((((int)blockIdx.x) >> 4) * 32768) +
               ((((int)threadIdx.x) >> 4) * 512)) +
              ((((int)blockIdx.x) & 15) * 32)) +
             (((int)threadIdx.x) & 15)) +
            24592))] = compute_local[(7)];
}
